...
/**
 * Tests A192KW JWE encryption and decryption.
 *
 * @author Melisa Halsband
 * @version $version$ (2014-08-19)
 */
public class A192KWTest extends TestCase {
	...
	public void testSetAcceptedAlgorithms()
		...
		decrypter.setAcceptedAlgorithms(new HashSet<>(Arrays.asList(JWEAlgorithm.A192KW)));
		assertTrue(decrypter.getAcceptedAlgorithms().contains(JWEAlgorithm.A192KW));
	...
	public void testWithA128CBC_HS256()
		...
		JWEHeader header = new JWEHeader(JWEAlgorithm.A192KW, EncryptionMethod.A128CBC_HS256);
	...
	public void testWithA192CBC_HS384()
		...
		JWEHeader header = new JWEHeader(JWEAlgorithm.A192KW, EncryptionMethod.A192CBC_HS384);
		Payload payload = new Payload("Hello world!");
	...
	public void testWithA256CBC_HS512()
		...
		JWEHeader header = new JWEHeader(JWEAlgorithm.A192KW, EncryptionMethod.A256CBC_HS512);
		Payload payload = new Payload("Hello world!");
	...
	public void testWithA128GCM()
		...
		JWEHeader header = new JWEHeader(JWEAlgorithm.A192KW, EncryptionMethod.A128GCM);
		Payload payload = new Payload("Hello world!");
	...
	public void testWithA192GCM()
		...
		JWEHeader header = new JWEHeader(JWEAlgorithm.A192KW, EncryptionMethod.A192GCM);
		Payload payload = new Payload("Hello world!");
	...
	public void testWithA256GCM()
		...
		JWEHeader header = new JWEHeader(JWEAlgorithm.A192KW, EncryptionMethod.A256GCM);
	...
	public void testWithDeprecatedA128CBC_HS256()
		...
		JWEHeader header = new JWEHeader(JWEAlgorithm.A192KW, EncryptionMethod.A128CBC_HS256_DEPRECATED);
		Payload payload = new Payload("Hello world!");
	...
	public void testWithDeprecatedA256CBC_HS512()
		...
		JWEHeader header = new JWEHeader(JWEAlgorithm.A192KW, EncryptionMethod.A256CBC_HS512_DEPRECATED);
		Payload payload = new Payload("Hello world!");
